...
function registerBlocks(){
  ...
  Blockly.Blocks['das_set_field']={init(){this.appendDummyInput().appendField('set').appendField(new Blockly.FieldDropdown(componentOptions),'TARGET');this.appendDummyInput().appendField('to').appendField(new Blockly.FieldDropdown(fieldOptions),'FIELD').appendField('from current record');this.setPreviousStatement(true);this.setNextStatement(true);this.setColour(colour.screen);this.setTooltip('Shows a database field in a screen component.');}};
  ...
  Blockly.Blocks['das_go_page']={init(){this.appendDummyInput().appendField('➡ go to').appendField(new Blockly.FieldDropdown(pageOptions),'PAGE');this.setPreviousStatement(true);this.setNextStatement(true);this.setColour(colour.navigation);this.setTooltip('Opens another page and keeps the current database record.');}};
